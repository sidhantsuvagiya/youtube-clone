    ...
    return (
        <div className='flex justify-between items-center flex-wrap py-1'>
            <div className='flex justify-between items-center py-2'>
                ...
                <Link to="/"><img className='w-24 ml-4' src="/images/youtube.svg" alt="Youtube" title='YouTube Home' /></Link>
            </div>
            <form onSubmit={(e) => getSearchResults(e)} className='w-full sm:w-auto flex justify-between items-center py-2'>
                <input
                    className='w-full sm:w-96 border border-gray-300 outline-blue-300 rounded-l-full px-4 py-2'
                    type="text"
                    placeholder='Search'
                    value={searchQuery}
            ...
            <div className='py-2 hidden sm:block'>
                <img className='w-8 h-8 rounded-full' src="/images/siddhant.jpeg" alt="user" />
            </div>
        </div>
    )
}
